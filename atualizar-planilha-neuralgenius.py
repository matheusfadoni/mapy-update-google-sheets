...
spreadsheet_id = '1d0fyzKKg2ngttMseST2MKPHc-voTMEOzD4y3lIy-4mE'
sheet_name = 'Hoja 1'
...
try:
    ...
    # Prepara os dados nas colunas A a F
    valores_novos = novos[['COD_ARTICULO', 'DESCRIPCION', 'PRECO', 'CATEGORIA', 'SUBCATEGORIA', 'MARCA']].values.tolist()
